...
<h2 align="center">👨‍💻 Обо мне и моей работе</h2>

<!-- Использование HTML-таблицы для создания двух колонок: текст + анимация -->
<table align="center" style="border: none;">
  <tr style="border: none;">
    <td width="60%" style="border: none;">
      <ul>
        <li>💼 В настоящее время работаю в <b>PRIME GO</b> на позиции <b>Fullstack Разработчик</b>.</li>
        <li>🔭 Работаю над крутым проектом: <b>PRIME GO SERVICES</b>.</li>
...
<h2 align="center">🛠 Инструменты и Технологии</h2>

<!-- Красивая сетка бейджей по центру -->
<p align="center">
  <b>Frontend:</b><br>
...
---
<p align="center">
  <i>Спасибо, что заглянул! ⭐ Не забудь поставить звездочку моим проектам, если они тебе понравились.</i>
</p>